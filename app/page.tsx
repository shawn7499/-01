    ...
    <div className="bg-black text-white">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-black/80 backdrop-blur border-b border-gray-800 px-6 py-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex gap-8">
            <a href="#about" className="text-gray-300 hover:text-white transition">{t.nav.whatIDo}</a>
            <a href="#projects" className="text-gray-300 hover:text-white transition">{t.nav.projects}</a>
            <a href="#roadmap" className="text-gray-300 hover:text-white transition">{t.nav.roadmap}</a>
      ...
      >
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-5xl text-center relative z-20">
          <h1 className="text-6xl md:text-8xl font-black mb-12 leading-tight tracking-tight">{t.hero.title}</h1>
          <h2 className="text-3xl md:text-5xl font-light mb-16 text-gray-200 leading-tight">{t.hero.subtitle}</h2>
      ...
      <section id="about" className="min-h-screen flex items-center justify-center px-6 py-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-20">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-20">
            <h2 className="text-5xl md:text-7xl font-black mb-8 leading-tight">{t.about.title}</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">{t.about.description}</p>
          </motion.div>
