...
export default function Home() {
  ...
  const content = {
    en: {
      hero: { title: 'Building the Future', subtitle: 'Beyond the Universe', mission: 'Taking Humanity Beyond the Universe' },
      intro: { text: 'Pioneering technology that enables humanity\'s cosmic exploration, scalable, and inevitable.' },
      whatIDo: {
        title: 'WHAT I DO',
        items: [
      ...
      projects: {
        ...
        items: [
          { number: '01', title: 'AI Creative Workshop', desc: 'Generate stunning images and videos with advanced AI models', tags: ['Image Generation', 'AI', 'Creative Tools'], icon: '🎬' },
          { number: '02', title: 'Trading Bot', desc: 'Automated quantitative trading with real-time profit generation', tags: ['Trading', 'Automation', 'Crypto'], icon: '💹' },
          { number: '03', title: 'OpenClaw Services', desc: 'Professional AI automation and custom integration services', tags: ['Automation', 'AI', 'Custom'], icon: '⚙️' },
        ],
      },
      roadmap: {
        ...
        phases: [
          { number: '01', phase: 'Capital Accumulation', period: '2024-2030', status: 'Current Phase', items: ['Build wealth through multiple streams', 'AI & trading automation', 'Web3 innovation', 'Market dominance'] },
          { number: '02', phase: 'Space & Technology', period: '2030-2040', status: 'Next Phase', items: ['Private space infrastructure', 'Advanced AI research', 'Quantum computing', 'Dimensional exploration'] },
          { number: '03', phase: 'Universal Transcendence', period: '2040+', status: 'Ultimate Goal', items: ['Multiverse exploration', 'Consciousness digitization', 'Dimensional ascension', 'Cosmic civilization'] },
        ],
      },
      contact: {
        title: 'CONNECT',
    ...
    zh: {
      hero: { title: '构建未来', subtitle: '超越宇宙', mission: '让人类超越宇宙' },
      intro: { text: '开创技术，让人类的宇宙探索成为可能、可扩展和必然。' },
      whatIDo: {
        title: '我的专长',
        items: [
      ...
      projects: {
        title: '活跃项目',
        items: [
          { number: '01', title: 'AI 创意工坊', desc: '使用先进 AI 模型生成令人惊叹的图像和视频', tags: ['图像生成', 'AI', '创意工具'], icon: '🎬' },
          { number: '02', title: '交易机器人', desc: '自动化量化交易，实时盈利生成', tags: ['交易', '自动化', '加密'], icon: '💹' },
          { number: '03', title: 'OpenClaw 服务', desc: '专业 AI 自动化和自定义集成服务', tags: ['自动化', 'AI', '定制'], icon: '⚙️' },
        ],
      },
      roadmap: {
        title: '使命路线图',
        subtitle: '构建超越宇宙的路径',
        phases: [
          { number: '01', phase: '资本积累', period: '2024-2030', status: '当前阶段', items: ['通过多种渠道建立财富', 'AI 和交易自动化', 'Web3 创新', '市场主导'] },
          { number: '02', phase: '空间与技术', period: '2030-2040', status: '下一阶段', items: ['私人空间基础设施', '先进 AI 研究', '量子计算', '维度探索'] },
          { number: '03', phase: '宇宙超越', period: '2040+', status: '终极目标', items: ['多元宇宙探索', '意识数字化', '维度升华', '宇宙文明'] },
        ],
      },
      contact: {
        title: '联系我',
  ...
  return (
    <>
      <CosmicBackground />
      <div className="relative z-10 bg-gradient-to-b from-transparent via-transparent to-black/50">
        {/* 导航栏 */}
        ...
        {/* What I Do Section */}
        <section className="min-h-screen flex items-center justify-center px-6 relative bg-gradient-to-b from-black via-slate-900 to-black py-20">
